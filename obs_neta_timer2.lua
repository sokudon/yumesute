...
--和暦表示　令和から
-- 令和%Vr年%m月%d日(%Vw)%H時%M分%S秒

--全部出し
--%UTC %c%DST %x%X%z %s %ISO %ISOZ %VR%m月%d日(%Vw)%H時%M分%S秒

--複数のタイムゾーン
--%JST UTC+?? %UTC UTC協定時間%ISOZ ISO8601 %ISO 

--あいますの情報を出す
--%JST %i %J%is %K%it %E%ie 
...
--%M minute (48) [00-59] 分 
--%m month (09) [01-12] 月 
--%n 改行 X現在は廃止されたっぽい、テキストエディタの改行をこぴぺでおｋ
--%p AM あるいは PM のロケール 
